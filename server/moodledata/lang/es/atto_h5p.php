...
/**
 * Strings for component 'atto_h5p', language 'es', branch 'MOODLE_38_STABLE'
 *
 * @package   atto_h5p
...
$string['instructions'] = 'Usted puede insertar contenido H5P por <strong>cualquiera</strong> sea ingresar una URL o o incrustar código desde un sitio H5P externoe <strong>o</strong>por medio de subir un archivo H5P.';
