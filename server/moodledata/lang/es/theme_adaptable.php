...
$string['xofyanswered'] = '{$ a-> completado} de {$ a-> participantes} Respondido';
$string['xofyattempted'] = '{$ a-> completado} de {$ a-> participantes} Intento';
$string['xofycontributed'] = '{$ a-> completado} de {$ a-> participantes} Contribuido';
$string['xofysubmitted'] = '{$ a-> completado} de {$ a-> participantes} Enviado';
